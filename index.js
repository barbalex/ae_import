...
const importObjectPropertyCollectionsFromPC = require('./src/importObjectPropertyCollectionsFromPC')
const importObjectPropertyCollectionsFromRC = require('./src/importObjectPropertyCollectionsFromRC')
...
async function doIt() {
  try {
    ...
    await importObjectPropertyCollectionsFromPC(pgDb, couchObjects)
    await importObjectPropertyCollectionsFromRC(pgDb, couchObjects)
    return pgp.end()
  } catch (error) {
    console.log(error)
    pgp.end()
