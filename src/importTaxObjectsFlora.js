  ...
  new Promise((resolve, reject) => {
    importTaxObjectsFloraLevel1(couchDb, pgDb, taxFlora)
      .then((result) => {
        ...
        return importTaxObjectsFloraLevel2(couchDb, pgDb, taxFlora, taxObjectsFloraLevel1)
      })
      .then((result) => {
        taxObjectsFloraLevel2 = result
        return importTaxObjectsFloraLevel3(couchDb, pgDb, taxFlora, taxObjectsFloraLevel1, taxObjectsFloraLevel2, couchObjects)
      })
      .then((result) => {
